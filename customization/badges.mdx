...
<Frame caption="The innovator badge is a badge that is given to users who have suggested features to help improve our platform.">
...
<Frame caption="The winner badge is given to users who have won an event held by haunt.">
  ![Winner Badge](../images/winner-badge.png)
</Frame>

### Second Place Badge

<Frame caption="The second place badge is given to anyone who came in second place in an event held by haunt.">
  ![Second Place Badge](../images/second-place-badge.png)
</Frame>

### Third Place Badge

<Frame caption="The third place badge is given to anyone who came in third place in an event held by haunt.">
  ![Third Place Badge](../images/third-place-badge.png)
</Frame>

<Note>
  You can see when we host an event in our [Discord server](https://discord.gg/hauntbio) to earn any of these three badges.
</Note>

### Inviter Badge

<Frame caption="The inviter badge is awarded to users who refer 5 new members to haunt.gg using their affiliate link.">
  ![Inviter Badge](../images/inviter-badge.png)
</Frame>
...
<Frame caption="Earned by gifting any product to another user.">
  ![Gifter Badge](../images/gifter-badge.png)
</Frame>

### Image Host Badge

<Frame caption="Earned by purchasing the Image Host storage extension">
  ![Image Host Badge](../images/image-host-badge.png)
</Frame>

<Note>
  **Image Host storage extension** can be purchased [here](https://haunt.gg/pricing).
</Note>

### Guild Tag Badge

<Frame caption="Earned by using our discord server tag">
  ![Guild Tag Badge](../images/guildtag-badge.png)
</Frame>
