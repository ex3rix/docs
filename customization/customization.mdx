...
<Card title="About Me" icon="circle-7" href="../customization/customization#about-me" horizontal>
...
<Note>
The parallax effect creates subtle movement in the background when the mouse moves.
</Note>
