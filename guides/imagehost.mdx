...
<Card title="ShareX Overlays" icon="circle-5" href="../guides/imagehost#sharex-overlay" horizontal>
Learn how to use ShareX Overlays
</Card>

<Card title="Discord Embed Customization" icon="circle-6" href="../guides/imagehost#discord-embed-customization" horizontal>
Learn how to customize the Discord embed for imagehost links.
</Card>

<Card title="Upload An Image" icon="circle-7" href="../guides/imagehost#upload-an-image" horizontal>
Learn how to upload an image to the imagehost.
</Card>

<Card title="Folders" icon="circle-8" href="../guides/imagehost#folders" horizontal>
Learn how to use folders and folder automations.
</Card>

<Card title="View Uploaded Images" icon="circle-9" href="../guides/imagehost#view-uploaded-images" horizontal>
Learn how to access your uploaded images.
</Card>

<Card title="Limits" icon="circle-10" href="../guides/imagehost#limits" horizontal>
...
<Steps>
  ...
  <Step title="Start customizing">
    You'll find various customization options such as domain, auto deletion, anonymous uploads, etc.
  </Step>
</Steps>
...
<Tip>
If you’d like to suggest a domain, [join our Discord server](https://discord.gg/hauntbio). To donate a domain, please open a ticket in the server. As a thank you, you get the Donator badges.
</Tip>
...
<Frame>
  ![Custom uploader settings button](../images/sharex-07.png)
</Frame>
</Step>
...
<Frame>
  ![Custom uploader settings](../images/sharex-08.png)
</Frame>
</Step>
...
<Step title="Done!">
Tap the blue **"+"** button — now your shortcut is ready! It will automatically upload the **latest image** from your photo library.
</Step>
...
You can verify that your API key and upload URL are correctly configured by viewing the script:
...
<Info>
Visit [Setup upload clients](https://help.haunt.gg/guides/imagehost#setup-upload-clients) to learn how to set up ShareX with the image host.
</Info>

<Steps>
  <Step title="Open Overlay Section">
    Go to the **Overlay** section under "imagehost" in the dashboard, or click [here](https://haunt.gg/dashboard/imagehost/overlays).
  </Step>
  <Step title="Download">
    Find the overlay you want and click **Download**.
  </Step>
  <Step title="Open File">
    Open the file you just downloaded.

    <Frame>
    ![ShareX Overlay File](../images/sharex-overlay-01.png)
    </Frame>

  </Step>
  <Step title="Confirm">
    When the confirmation dialog appears, click **Yes** to install the overlay.
  </Step>
  <Step title="Done!">
    That’s it! The overlay is now ready to use in ShareX.
  </Step>
</Steps>

<Frame>
  ![ShareX Overlay Example](../images/sharex-overlay-example.png)
</Frame>

<Tip>
You can download multiple overlays and switch between them easily.  
Just open ShareX, go to **After capture tasks → Add image effects**.

<Frame>
  ![ShareX After capture tasks](../images/sharex-overlay-02.png)
</Frame>
</Tip>
...
<Steps>
  <Step title="Open the Folders section on the dashboard">
    Visit [haunt.gg/dashboard/imagehost/folders](https://haunt.gg/dashboard/imagehost/folders).
  </Step>
  <Step title="Create Folder">
    Click the **"Create Folder"** button to create a new folder.

    <Frame>
      ![Create Folder Interface](../images/folders-02.png)
    </Frame>
  </Step>
  ...
  <Step title="Privacy">
    Select Privacy between Public, Private, or Password Protected.
  </Step>
  <Step title="Done">
    Your folder is now created! You can move images into this folder from the gallery.

    <Frame>
      ![Move file into folder interface](../images/folders-03.png)
    </Frame>
    ...
    <Frame>
      ![Image Host Folders Interface](../images/folders-01.png)
    </Frame>
...
<Steps>
  ...
  <Step title="Automations Tab">
    Switch to **Automations** Tab on top.
  </Step>
  <Step title="Create Rule">
    Click **Create Rule** at the top right and enter the trigger and the folder. 

    <Frame>
      ![Create Rule Interface](../images/folders-04.png)
    </Frame>
  </Step>
  <Step title="Done">
    You're all set! All files that contain the trigger will be automatically added to the folder you set.
  </Step>
</Steps>
...
| Feature         | Free               | Premium           | Image Host Subscription |
|-----------------|--------------------|-------------------|-------------------------|
| Storage         | 1GB (1,024 MB)     | 10GB (10,240 MB)   | 100GB (102,400 MB)      |
| File Size Limit | 100 MB             | 250 MB             | 500 MB                  |

<Info>
The Image Host subscription with the most storage and the largest file size limit can be purchased [here](https://haunt.gg/pricing). If you purchase this product, you will also receive the [Image Host badge](https://help.haunt.gg/customization/badges#image-host).
</Info>

<Info>
Available payment methods can be found [here](../overview/payment-methods).
</Info>
