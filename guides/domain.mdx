...
<Steps>
    ...
    <Step title="Head to the Haunt.gg Discord">
        Head to the Haunt.gg discord server, then click on the cmds channel, and enter the command: `/domain connect [Domain] [Record_Value]` The Record_Value is the content that you copied.
        <Frame>
